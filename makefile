...
INC_DIR := ./inc/model ./inc/library ./inc/musicplayer ./inc/algorithm
SRC_DIR := ./src/model ./src/library ./src/musicplayer ./src/algorithm ./src
...
OBJECT = build/main.o build/MusicLibrary.o build/Song.o build/PlaybackQueue.o build/SmartPlaylist.o build/PlayNextQueue.o build/ShuffleManager.o build/PlaybackHistory.o
